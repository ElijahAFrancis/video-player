...
//     // Simulate the file upload and store the title and path
...
//     formData.append('file', selectedFile); // 'selectedFile' is the file object from your input field
...
function Upload() {
  ...
  //   uploadVideo({ variables: { title: videoTitle, path: selectedFile.name } }) // Call the GraphQL mutation
  //     .then((response) => {
